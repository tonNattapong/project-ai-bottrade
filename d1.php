...
<body>
  ...
  <div class="container">
    <div class="box">
        <a href=""><img src="img/EURUSD.png" alt=""></a>
        <h1>EURUSD</h1>
       
    </div>
        
    <div class="box">
        <a href=""><img src="img/USDCAD.png" alt=""></a>
        <H1>USDCAD</H1>
    </div>
    <div class="box">
        <a href=""><img src="img/GBPUSD.png" alt=""></a>
        <H1>GBPUSD</H1>
    </div>
    <div class="box">
        <a href=""><img src="img/USDJPY.png" alt=""></a>
        <H1>USDJPY</H1>
    </div>
    <div class="box">
        <a href=""><img src="img/USDCHF.png" alt=""></a>
        <H1>USDCHF</H1>
    </div>
    <div class="box">
        <a href=""><img src="img/XAUUSD.png" alt=""></a>
        <H1>XAUUSD</H1>
    </div>
  </div>
